...
export const createCategory = async (categoryData) => {
    try {
        const [result] = await pool.query(
            "INSERT INTO category (title, description, parent_category_id, color, is_root, user_id) VALUES (?, ?, ?, ?, ?, ?)",
            [categoryData.name, categoryData.description, categoryData.parentId, categoryData.color, categoryData.isRoot || 0, categoryData.userId || 1]
        );
